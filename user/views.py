...
def login_page(request):
    ...
    sanction_msg = ""
    context = {"form": form, "sanction_msg": sanction_msg}
...
def register_page(request):
    ...
    if request.method == "POST":
        ...
        form = UserForm()
    context = {"form": form, "breach_message": ""}
...
def landingpage(request):
    ...
    appointments = Appointments.objects.filter(patientid=request.user.id).order_by(
        "datetime"
    )
    context = {
        "username": username,
...
def show_medical_details(request):
    ...
    return render(
        request, "user/show_medical_details.html", {"medicalDetails": medicalDetails}
    )
...
def show_medical_card(request):
    ...
    return render(
        request, "user/show_medical_card.html", {"medicalDetails": "medicalDetails"}
    )
